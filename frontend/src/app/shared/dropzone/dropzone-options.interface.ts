export interface DropzoneOptionsInterface {
  ...
  removedfile?: DropzoneRemoveFileFunction;
  error?: DropzoneErrorFunction;
}
...
export type DropzoneRemoveFileFunction = (file: any) => void;
export type DropzoneErrorFunction = (file: any, message: any) => void;
